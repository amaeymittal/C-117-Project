...
sketchtodraw = quick_draw_data_set[random_number] 
console.log(sketchtodraw);
document.getElementById("SketchID").innerHTML = "Sketch to be drawn is a "+sketchtodraw;
...
function updateCanvas() {
    ...
    1); console.log(quick_draw_data_set[random_number]);
